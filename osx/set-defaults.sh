...
# taken from @holman: https://github.com/holman/dotfiles/blob/master/osx/set-defaults.sh
# with some of @mathiasbynens's stuff added too
# actually I decided it would be easier to simply comment out whatever
# options of #mathiasbynen's that I didn't want
...
# Dropbox is handling screenshot stuff for now ...
...
defaults write com.apple.finder NewWindowTargetPath -string "file:///Users/homebrew/"
...
# I use spectacle (maybe hydra in future) instead
